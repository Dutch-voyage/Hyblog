  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        id: 'e',
        text: {
          en: 'Skip the anime frame; give me the lab memo without character arcs',
          zh: '跳过动画框架；给我没有人物弧光的实验室备忘录',
        },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        id: 'e',
        text: {
          en: 'Not a game loop; more like a grant deadline wearing a trench coat',
          zh: '不是游戏循环；更像穿着风衣的基金截止日期',
        },
        scores: { gamerType: 2 },
      },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        id: 'c',
        text: {
          en: 'Neither; dessert is optional and I am here for the main course',
          zh: '都不是；甜点是可选的，我是来吃主菜的',
        },
        scores: { otakuAlignment: 2, gamerType: 2 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        id: 'c',
        text: {
          en: 'Neither; close the tab, annotate the paper, sleep like a civilized mammal',
          zh: '都不是；关标签页、批注论文，像文明哺乳动物一样睡觉',
        },
        scores: { otakuAlignment: 2, gamerType: 2, lifeRhythm: 2 },
      },
    ],
  },
  // ==================== OPEN REFLECTIONS (31-33) ====================
  {
    id: 'q31',
    kind: 'reflection',
    text: {
      en: 'Open notebook prompt: your lab can write only one honest sentence about the next five years. It says:',
      zh: '开放笔记题：你的实验室只能写一句关于未来五年的诚实判断。它会是：',
    },
    options: [
      {
        id: 'a',
        text: {
          en: 'Capability will keep arriving before language for responsibility catches up.',
          zh: '能力会继续先于责任语言抵达。',
        },
        scores: { riskOrientation: 2, alignmentPriority: 1, governanceStance: 5, contentFormat: 1 },
      },
      {
        id: 'b',
        text: {
          en: 'The winning labs will be the ones that turn messy users into a learning signal.',
          zh: '胜出的实验室会是那些把混乱用户变成学习信号的人。',
        },
        scores: { riskOrientation: 5, alignmentPriority: 4, stackLayer: 1, knowledgeMode: 7, shippingSpeed: 6 },
      },
      {
        id: 'c',
        text: {
          en: 'The deepest discoveries will still come from games, science, and controlled worlds.',
          zh: '最深的发现仍会来自游戏、科学和可控世界。',
        },
        scores: { riskOrientation: 4, alignmentPriority: 4, stackLayer: 4, knowledgeMode: 2, scope: 7, evaluationStyle: 1 },
      },
      {
        id: 'd',
        text: {
          en: 'Compute is not destiny; the important variable is what humans dare to measure.',
          zh: '算力不是命运；真正重要的变量是人类敢测量什么。',
        },
        scores: { riskOrientation: 3, alignmentPriority: 3, knowledgeMode: 1, evaluationStyle: 1, scope: 6 },
      },
    ],
  },
  {
    ...
    kind: 'reflection',
    text: {
      en: 'When public pressure and your best technical judgment disagree, you would rather be accused of:',
      zh: '当公众压力与你最好的技术判断冲突时，你宁愿被指责为：',
    },
    options: [
      {
        id: 'a',
        text: {
          en: 'Moving too slowly because the unknowns were not performative.',
          zh: '行动太慢，因为未知不是表演出来的。',
        },
        scores: { riskOrientation: 2, alignmentPriority: 1, shippingSpeed: 1, governanceStance: 6 },
      },
      {
        id: 'b',
        text: {
          en: 'Moving too quickly because deployment taught what discourse could not.',
          zh: '行动太快，因为部署教会了讨论无法教会的东西。',
        },
        scores: { riskOrientation: 6, alignmentPriority: 5, shippingSpeed: 7, knowledgeMode: 7 },
      },
      {
        id: 'c',
        text: {
          en: 'Being too empirical because beautiful arguments kept failing contact with data.',
          zh: '过度经验主义，因为漂亮论证总是在数据面前失败。',
        },
        scores: { riskOrientation: 4, alignmentPriority: 4, evaluationStyle: 1, knowledgeMode: 5, scope: 7 },
      },
      {
        id: 'd',
        text: {
          en: 'Being too political because frontier models are institutions, not just artifacts.',
          zh: '过度政治化，因为前沿模型是制度，不只是产物。',
        },
        scores: { riskOrientation: 4, alignmentPriority: 3, governanceStance: 6, collaborationStyle: 6 },
      },
    ],
  },
  {
    ...
    kind: 'reflection',
    text: {
      en: 'Which burden would you voluntarily carry?',
      zh: '你愿意主动背负哪一种负担？',
    },
    options: [
      {
        id: 'a',
        text: {
          en: 'Being the person who says no before everyone understands why.',
          zh: '成为那个在所有人理解原因之前先说“不”的人。',
        },
        scores: { riskOrientation: 1, alignmentPriority: 1, governanceStance: 6, shippingSpeed: 1 },
      },
      {
        id: 'b',
        text: {
          en: 'Being the person who turns a vague technological era into usable defaults.',
          zh: '成为那个把模糊技术时代变成可用默认值的人。',
        },
        scores: { riskOrientation: 5, alignmentPriority: 4, stackLayer: 1, knowledgeMode: 7, aestheticSense: 6 },
      },
      {
        id: 'c',
        text: {
          en: 'Being the person who proves, with experiments, which dreams were real.',
          zh: '成为那个用实验验证哪些梦想是真的的人。',
        },
        scores: { riskOrientation: 4, alignmentPriority: 4, stackLayer: 4, knowledgeMode: 2, evaluationStyle: 1, scope: 7 },
      },
      {
        id: 'd',
        text: {
          en: 'Being the person who makes the infrastructure so good that nobody notices it.',
          zh: '成为那个把基础设施做到无人察觉的人。',
        },
        scores: { riskOrientation: 4, stackLayer: 7, knowledgeMode: 7, aestheticSense: 1 },
      },
    ],
  },
];
